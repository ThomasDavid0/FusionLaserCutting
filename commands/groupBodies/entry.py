...
CMD_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_group_bodies'
CMD_NAME = 'Group Bodies'
CMD_Description = 'group bodies into components based on thickness and material'
IS_PROMOTED = False
